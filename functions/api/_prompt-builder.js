...
- Se il tipo è FILE_UPLOAD o simile e il contenuto sembra un'immagine o un video (galleria), usa l'URL fornito direttamente come sorgente nel codice.
- Se il tipo è FILE_UPLOAD e il contenuto sembra un documento (es. listino, menu), NON provare a leggerne il contenuto e non inventarlo: genera un placeholder esplicito per quella sezione (es. "Listino in aggiornamento") e segnala la situazione in flagged_requests.
