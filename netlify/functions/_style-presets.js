...
// Se aggiungi/modifichi un preset o una variante, questo è l'UNICO file da toccare:
// il prompt builder lo legge da qui, quindi non c'è rischio di disallineamento
// tra "quello che dice la documentazione" e "quello che l'AI riceve davvero".
...
// Blacklist valida per TUTTI i preset — indipendentemente dallo stile scelto,
// questi sono i tic riconoscibilissimi dell'output AI di default e vanno sempre evitati.
const ANTI_AI_LOOK_RULES = [
...
// Determina in modo deterministico preset+variante per un ordine.
// Il preset arriva dalla scelta del cliente nel configuratore (o da "Pensaci tu" -> mappato a un preset per settore).
// La variante è calcolata dall'Order ID, così è riproducibile: rigenerando lo stesso
// ordine (es. per una revisione) esce sempre la stessa variante, nessuna sorpresa.
...
// Mappatura di fallback per "Pensaci tu!" — associazione settore -> preset.
// Va ampliata mano a mano che emergono settori ricorrenti dai dati reali.
